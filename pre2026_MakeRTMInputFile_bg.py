...
if __name__ == "__main__":
    ...
    # additional_spesifications += '_wc_test_atm_0'
            # Edge effects test 
    # additional_spesifications += '_TEST_edge_effects_Small_Large'; edge_buffer = 14  # 41-13/2=14     31-13/2=9       41-31/2=5   41-23/2=9   23-13/2=5  17-13/2=2
    additional_spesifications += '_TEST'
    ...
    for SceneName in SceneNames:
        ...
        if Test == False:
            ...
            ialongs = [target_idx]
            print(f'Latitude             = {ACMCOM.latitude_active[target_idx]:.2f}   ialongs = {ialongs}')
