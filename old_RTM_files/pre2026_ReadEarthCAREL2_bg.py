...
if __name__ == "__main__":
    ...
    additional_spesifications2 =   '_TEST_edge_effects_Mega_Giga'    # _TEST_edge_effects_Small_Giga
    ...
    # additional_spesifications += '_all_levels'
            # Edge effects test 
    # additional_spesifications += '_TEST_edge_effects_Small_Mega'
    # additional_spesifications += '_TEST_edge_effects_Small_Giga'
